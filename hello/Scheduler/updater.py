...
def start():
    ...
    scheduler.add_job(gamedata.get_api_data,"cron",hour=21,minute=10,second=00, id="API_job", replace_existing=True)
    ...
    # scheduler.add_job(gamedata.calculate_payout_sport,"cron",hour=21 ,minute=5,second=00, id="Payout_job", replace_existing=True)
