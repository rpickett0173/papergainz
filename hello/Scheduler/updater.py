...
def start():
    ...
    scheduler.add_job(gamedata.calculate_payout_esport, "cron",hour=1,minute=50,second=0, id="eSportPayout_job", replace_existing=True)
    scheduler.add_job(gamedata.calculate_payout_sport, "cron",hour=1,minute=50,second=0, id="SportPayout_job", replace_existing=True)
