...
class Bets(models.Model):
    ...
    date_placed = models.DateTimeField(auto_now=True) #auto_now automatically makes this value the current time when the method is called
...
class Odds(models.Model):
    ...
    team1_odds = models.DecimalField(max_digits=3, decimal_places=2)
    team2_odds = models.DecimalField(max_digits=3, decimal_places=2)
    def __str__(self):
        return self.game_ID
